...
def open_pdf(bucket_name,dict_data,url):
    ...
    #         st.image(image_list[i])
        ...
        st.markdown(f'<embed src="https://drive.google.com/file/d/1aqpSMct4v_onKLbpy7Ndmk6fAspngdiy/view?usp=drive_link" width="400" height="400">', unsafe_allow_html=True)
