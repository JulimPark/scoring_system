...
def open_pdf(bucket_name,dict_data,url):
        ...
        st.markdown(f'<iframe src="https://drive.google.com/file/d/16yQdBYpvVuSQry9bzGH5RSeWoDVFRKA3/preview#toolbar=0" width="600" height="720">', unsafe_allow_html=True)
